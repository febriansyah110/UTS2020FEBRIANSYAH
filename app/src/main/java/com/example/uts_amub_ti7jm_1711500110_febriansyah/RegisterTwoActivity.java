...
public class RegisterTwoActivity extends AppCompatActivity {
    ...
    ImageButton img_btn_register_two;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_add_photo = findViewById(R.id.img_btn_tambah_photo);
        img_btn_register_two = findViewById(R.id.img_btn_register);
        ...
        img_btn_register_two.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
